<section class="section pt-4" style="margin-top: 70px; ">
            <div class="container">
                <div>
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12" data-simplebar style="height: 60vh; overflow-x: hidden;">
                            ...
                            <div class="row align-items-center pt-4">
                                <div class="col-md-4 col-sm-8">
                                    <div>
                                        ...
                                        <p style="margin-top: -20px; font-size: 10px;">Executive Director, Philippine Council for Health</p>
                                        <p style="margin-top: -20px; font-size: 10px;">Research and Development</p>
                                        </div>

                                    </div>
                                </div>
                                <div class="col-md-8 ml-auto">
                                    <div class="mt-4 mt-md-auto text-darker font-size-10" data-simplebar style="height: 20vh; overflow-x: hidden;">
