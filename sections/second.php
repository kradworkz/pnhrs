                    ...
                    <div class="mt-4 text-muted">
                        ...
                        <div class="table-responsive mt-3" style="cursor:pointer">
                            <table class="table table-centered table-nowrap table-hover mb-0">
                                <tbody>
                                    <tr v-for="(list,index) in lists.first" v-bind:key="list.index">
            ...
            <div class="col-xl-12 mb-3">
                <div class="blog-box mb-4 mb-xl-0">
                    <div class="mt-4 text-muted">
                        ...
                        <div v-for="(list,index) in lists.second" v-bind:key="list.id" class="text-muted mt-4" style="cursor:pointer">
