<section class="section pt-4" style="margin-top: 40px;">
    <div class="container"> 
        <div>
            <ul id="lobby">
                <li class="l-about zoom2"></li>
                <li class="l-guidelines zoom2"></li>
                <li class="l-student zoom2"></li>
                <li class="l-pro zoom2"></li>
            </ul>
        </div>
    </div>
</section>
...
<head>
        ...
        <style>
            body {
                ...
                background: url('assets/images/landing/new/lobby.jpg') no-repeat center center fixed; 
