                        ...
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="mt-4 text-muted">
                                ...
                                <div class="text-muted mt-4" style="cursor:pointer"> 
                                    ...
                                    <p @click="openmodal1('https://us02web.zoom.us/webinar/register/WN_BUZ-ntn_SI-I9qMJyMVuKA','August 05, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Enhancing Regional Preparedness for Public Health Emergencies &nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 05, 2021 | 8 AM - 12 NN</span>&nbsp;&nbsp;&nbsp;<span class="font-size-10 text-info"><i class='bx bx-map-pin'></i> Visayas Cluster</span></p>
                                    <p @click="openmodal1('https://us02web.zoom.us/webinar/register/WN_6k1-qA-5RUe7F231-IPuow','August 06, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Ensuring Good Governance and Accountability in the New Normal &nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 06, 2021 | 8 AM - 12 NN</span>&nbsp;&nbsp;&nbsp;<span class="font-size-10 text-info"><i class='bx bx-map-pin'></i> Mindanao Cluster</span></p> -->
                              
                                <p @click="openmodal1('https://us02web.zoom.us/webinar/register/WN_B1HGEtFjQjyqjJQXl_KWGw','August 03, 2021')" class="mb-2 text-truncate" ><i class="mdi mdi-circle-medium text-warning me-1"></i> South Luzon Cluster &nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 03, 2021 | 8 AM - 12 NN</span>&nbsp;&nbsp;&nbsp;</p>
                                    <p @click="openmodal1('https://zoom.us/webinar/register/WN_qrQQF9gaQzua-A2-pTuRSg','August 04, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i> North Luzon Cluster &nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 04, 2021 | 8 AM - 12 NN</span>&nbsp;&nbsp;&nbsp;</p>
                                    <p @click="openmodal1('https://us02web.zoom.us/webinar/register/WN_BUZ-ntn_SI-I9qMJyMVuKA','August 05, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i> Visayas Cluster &nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 05, 2021 | 8 AM - 12 NN</span>&nbsp;&nbsp;&nbsp;</p>
                                    <p @click="openmodal1('https://us02web.zoom.us/webinar/register/WN_6k1-qA-5RUe7F231-IPuow','August 06, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i> Mindanao Cluster &nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 06, 2021 | 8 AM - 12 NN</span>&nbsp;&nbsp;&nbsp;</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="mt-4 text-muted">
                                ...
                                <div class="text-muted mt-4" style="cursor:pointer">
                                    <h6 style="margin-left: 20px;"> <span class="text-info"><i class='bx bx-calendar'></i> Day 1  </span> </h6>
                                    <div style="margin-left: 35px;">
                                    ...
                                    <h6 style="margin-left: 20px;"> <span class="text-info"><i class='bx bx-calendar'></i> Day 2 </span> </h6>
                                    <div style="margin-left: 35px;">
