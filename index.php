                        ...
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="mt-4 text-muted">
                                ...
                                <div class="text-muted mt-4" style="cursor:pointer">
                                    ...
                                    <p @click="openmodal1('https://us02web.zoom.us/webinar/register/WN_0wrnbsM1R5iGsWKqRt8oCQ','August 04, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Strengthening the National Health Research System’s Capacity for Response and Research &nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 04, 2021 | 8 AM - 12 NN</span>&nbsp;&nbsp;&nbsp;<span class="font-size-10 text-info"><i class='bx bx-map-pin'></i> North Luzon Cluster</span></p>
