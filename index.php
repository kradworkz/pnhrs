                        ...
                        <vue-slick-carousel :autoplay="true" :autoplaySpeed="10000" :dots="true" :options="slickOptions">
                            ...
                            <div class="slide-3">
                                <div class="text-white-50">
                                    ...
                                    <hr>
                                    <div class="text-white mt-4 para" style="cursor:pointer">
                                        <p @click="openmodal('','August 09, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation (Student Category)</p>
                                        <p @click="openmodal('','August 09, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation (Professional Category)</p>
                        ...
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="mt-4 text-muted">
                                ...
                                <div class="text-muted mt-4" style="cursor:pointer">
                                    ...
                                    <p class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Practical Training for Regional Ethics Committee Members and Staff&nbsp; <span class="badge bg-danger text-white">By Invitation Only</span> &nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 11, 2021 | 8 AM - 4 PM</span></p>
                                    <p class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Visual Abstract Poster Competition&nbsp; <span class="badge bg-danger text-white">By Invitation Only</span> &nbsp;| &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 11, 2021 | 8 AM - 12 NN</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
