                        ...
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="mt-4 text-muted">
                                ...
                                <div class="text-muted mt-4" style="cursor:pointer">
                                    ...
                                    <p @click="openmodal1('https://us02web.zoom.us/webinar/register/WN_wvTDUmJWQV23CQEbFnm3DQ','August 09, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation - Professional Category&nbsp;&nbsp;&nbsp;<span class="font-size-10"><i class='bx bx-calendar'></i> August 03, 2021 | 1 - 4 PM</span></p>
