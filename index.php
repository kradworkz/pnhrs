                        ...
                        <vue-slick-carousel :autoplay="true" :autoplaySpeed="10000" :dots="true" :options="slickOptions">
                            ...
                            <div class="slide-3">
                                <div class="text-white-50">
                                    ...
                                    <hr>
                                    <div class="text-white mt-4 para" style="cursor:pointer">
                                        <p class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation (Student Category) &nbsp; <span class="badge bg-danger text-white">By Invitation Only</span> &nbsp; </p>
                                        <p class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation (Professional Category) &nbsp; <span class="badge bg-danger text-white">By Invitation Only</span> &nbsp; </p>
                    ...
                    <div class="col-xl-12">
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="mt-4 text-muted">
                                ...
                                <div class="text-muted mt-4" style="cursor:pointer">
                                    <p class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation - Student Category&nbsp; <span class="badge bg-danger text-white">By Invitation Only</span> &nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 09, 2021 | 8 AM - 12 NN </span></p>
                                    <p class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation - Professional Category&nbsp; <span class="badge bg-danger text-white">By Invitation Only</span> &nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 09, 2021 | 1 - 4 PM </span></p>
                                    <p @click="openmodal1('https://us02web.zoom.us/webinar/register/WN_4V-Qlp41TyCDokWC1bot3A','August 09, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Talk on Social Innovation in Health Research&nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 09, 2021 | 8 AM - 12 NN</span></p>
                                    <p @click="openmodal1('https://us02web.zoom.us/webinar/register/WN_s-isBFZESkinjrB_YXkQ8g','August 10, 2021')" class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Moral Compass for Emergency Research and the Importance and Nature of Community Consultation&nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 10, 2021 | 8 AM - 12 NN</span></p>
