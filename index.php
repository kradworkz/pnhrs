                        ...
                        <vue-slick-carousel :autoplay="true" :autoplaySpeed="10000" :dots="true" :options="slickOptions">
                            ...
                            <div class="slide-3">
                                <div class="text-white-50">
                                    ...
                                    <hr>
                                    <div class="text-white mt-4 para" style="cursor:pointer">
                                        <p class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation (Student Category) [Invitational Only]</p>
                                        <p class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation (Professional Category) [Invitational Only]</p>
                    ...
                    <div class="col-xl-12">
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="mt-4 text-muted">
                                ...
                                <div class="text-muted mt-4" style="cursor:pointer">
                                    <p class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation - Student Category&nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 09, 2021 | 8 AM - 12 NN </span> <span class="font-size-10 text-danger">(Invitational Only)</span></p>
                                    <p class="mb-2 text-truncate"><i class="mdi mdi-circle-medium text-warning me-1"></i>Oral Research Presentation - Professional Category&nbsp;&nbsp;&nbsp; | &nbsp;<span class="font-size-10 text-info"><i class='bx bx-calendar'></i> August 09, 2021 | 1 - 4 PM </span> <span class="font-size-10 text-danger">(Invitational Only)</span></p>
